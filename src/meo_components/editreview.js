...
function EditReview() {
    ...
    const loadEditReview = () => {
        const result = axios.get(`http://127.0.0.1:8000/api/editreview/${id}`)
            .then(response => {
    ...
    const Edit = () => {
        const result = axios.post(`http://127.0.0.1:8000/api/editreviewoparation/${id}`, JSON.stringify(data), { headers: { "Content-Type": "application/json" } })
            .then(response => {
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card m-lg-5">
                                    <div class="card-body">
                                        <div class="form-validation" class="alert alert-danger">
                                            <form onSubmit={(e) => submitted(e)} class="form-valide">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label"
                                                        for="val-confirm-password">PROBLEM DESCRIPTION<span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
