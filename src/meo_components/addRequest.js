...
function AddRequest() {
    ...
    const load = () => {
        console.log("te");
        const result = axios.post("http://127.0.0.1:8000/api/addrequest", JSON.stringify(data), { headers: { "Content-Type": "application/json" } })
            .then(response => {
                                    ...
                                    <div class="card-body" >
                                        <div class="form-validation">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-request_type">REQUEST TYPE <span
                                                        class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="val-request_type" name="request_type"
                                                            placeholder="Your valid Request Type" onChange={(e) => onchange(e)} name="request_type" value={data.request_type} />
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <textarea type="text" class="form-control"
                                                            ...
                                                            placeholder="Enter Description" onChange={(e) => onchange(e)} name="description" value={data.description} />
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="val-status" 
                                                            name="status" placeholder="Enter the status of request" onChange={(e) => onchange(e)} name="status" value={data.status} />
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <button type="submit"
                                                            class="btn btn-dark w-100">ADD REQUEST</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
