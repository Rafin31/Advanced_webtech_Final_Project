...
function ViewReview() {
    ...
    const loadViewReview = () => {
        const result = axios.get(`http://127.0.0.1:8000/api/viewreview/${id}`)
            .then(response => {
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card m-lg-5">
                                    <div class="card-body" class="alert alert-danger">
                                        <div class="form-validation">
                                            <form class="form-valide">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <h4><input type="text" class="alert alert-primary" value={data.request_type} disabled/></h4>
